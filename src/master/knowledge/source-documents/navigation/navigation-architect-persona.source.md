...
verbatim: true
do-not-edit: true
origin-file: GENERAL_PROMPT_for_NAV_BARS_AND_NAV_PAGES-2.docx
category: navigation
cross-cuts: ui-ux, accessibility, motion, footer, brand-identity, mobile, messaging
partner: partner-documents/navigation/navigation-architect-persona.partner.md
---

<!--
  ============================================================
  DO NOT EDIT THIS FILE.
  This is a verbatim embed of the user-provided source document.
  All adaptation, brand mapping, and decision-guidance lives in the
  partner document referenced in the frontmatter above.
  Wedding/piano framing, "VeePo"-era references, citation tokens
  (e.g. 【...†L...】), the <mark>FANTASY.CO</mark> artefact, mixed
  bullet styles, and the trailing operational hook are all
  preserved as-is per the knowledge-system charter.
  ============================================================
-->

# GENERAL_PROMPT_for_NAV_BARS_AND_NAV_PAGES-2.docx
...
- Create comprehensive documentation for each navigation component: code snippets, design tokens for colors, spacing and typography, usage guidelines, and examples. Include responsive behavior specifications, accessibility

## Page 4

requirements, and guidelines for adaptation.
